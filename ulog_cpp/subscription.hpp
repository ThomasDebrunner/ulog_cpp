...
class TypedDataView {
 public:
  ...
  Value at(const std::shared_ptr<Field> &field) const {
        return at(*field);
  }
...
class Subscription {
 public:
  ...
  {
    return _message_format->fieldNames();
  }
  ...
  auto begin() { return SubscriptionIterator<std::vector<Data>::iterator>(_samples.begin(), _message_format); }
  auto end() { return SubscriptionIterator<std::vector<Data>::iterator>(_samples.end(), _message_format); }

  auto begin() const { return SubscriptionIterator<std::vector<Data>::const_iterator>(_samples.begin(), _message_format); }
  auto end() const { return SubscriptionIterator<std::vector<Data>::const_iterator>(_samples.cend(), _message_format); }
